    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          accent: 'var(--color-brand-accent)', // blue-500
        },
      ...
      boxShadow: {
        ...
        'lg': 'var(--shadow-lg)',
        'xl': 'var(--shadow-xl)',
        'card': '0 4px 16px rgba(15, 23, 42, 0.1)',
        'elevated': '0 8px 32px rgba(15, 23, 42, 0.15)',
        'interactive': '0 8px 32px rgba(59, 130, 246, 0.15)',
      },
      transitionDuration: {
